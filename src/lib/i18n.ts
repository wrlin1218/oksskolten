...
const dict = {
  ...
  'deepl.baseUrl': { ja: 'DeepLX サーバー URL', en: 'DeepLX Server URL' },
  'deepl.baseUrlDesc': { ja: '任意。設定すると DeepL 公式 API の代わりに DeepLX を使用します', en: 'Optional. When set, use DeepLX instead of the official DeepL API' },
  'deepl.baseUrlPlaceholder': { ja: 'http://localhost:1188', en: 'http://localhost:1188' },
  ...
  'openai.baseUrl': { ja: 'OpenAI Base URL', en: 'OpenAI Base URL' },
  'openai.baseUrlDesc': { ja: '任意。OpenAI 互換 API やプロキシを使用する場合に設定します', en: 'Optional. Set this for an OpenAI-compatible API or proxy' },
